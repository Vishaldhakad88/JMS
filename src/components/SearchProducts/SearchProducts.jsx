...
const SearchProducts = () => {
  ...
  return (
    <div className="py-10 px-4 sm:px-6 lg:px-10 bg-gray-50 min-h-screen">
      {/* ===== Heading & Search Bar ===== */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-400 outline-none text-sm bg-white shadow-sm"
          />
        </div>
      </div>
          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="flex items-center gap-1 bg-orange-500 text-white px-3 py-1 rounded-full hover:bg-orange-600 transition">
                  <IoAddCircle size={18} />
